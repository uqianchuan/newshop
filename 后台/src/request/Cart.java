...
public class Cart extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sqlQuery = "select c.float_number,c.g_number,g.gname,g.gmoney,g.gkinds,g.gid,g.gpicture from " + DBUtils.GOODS + " g," +DBUtils.CAR + " c where g.gid = c.gid and c.login_id='" + account + "'";
