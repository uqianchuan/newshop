...
public class Order extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sqlQuery = "select d.dd_date,d.dd_money,con.count,con.gname,con.gpicture from " + DBUtils.ORDERING + " d," +DBUtils.CONNECT + " con where d.dd_id = con.dd_id and d.login_id='" + account + "'";
